...
const LandingPage = () => {
  return (
    <div className="container">
      <div className={`row ${styles.secondContainer} d-flex justify-content-center`}>
        <div className={`col-lg-4 text-center`}>
          <img
            src="https://www.bumeran.com.ar/candidate/static/media/login.e6658ac3.svg"
            alt="imagen"/>
        </div>
        <div className={`col-12 col-lg-6 mt-5 mt-lg-1 d-flex justify-content-center ${styles.txtContainer}`}>
          <p className="lead fs-2 title text-center text-lg-start ">Reinventando el Reclutamiento</p>
          <p className={`${styles.message} text-center text-lg-start`}>Somos la primera plataforma tecnológica aplicada a la selección de talento.</p>
