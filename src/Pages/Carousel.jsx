...
const CarouselReport = () => {
    ...
    useEffect(() => {
        dispatch(getSearchBar())
            .then(res => setSearchBar(LogicSearch(res.payload)))
        dispatch(getSearchPolar())
            .then(res => setSearchPolar(res.payload))
        dispatch(getRecruiterPolar())
            .then(res => setRecruiterPolar(LogicRecruiter(res.payload)))
        dispatch(getRecruiterBar())
            .then(res => setRecruiterBar((res.payload)))
    }, [])
                        ...
                        <div className="containerCarousel">
                            ...
                            <div >
                                <PolarArea options={optionsPolar} data={
                                    {
                                        labels: searchPolar?.map(({ state_search }) => state_search),
                                        datasets: [
                                            {
                                                label: '# of Votes',
                    ...
                    <Carousel.Caption bsPrefix={"containerCarouselSearch"}>
                        ...
                        <div className="containerCarousel">
                            <div >
                                <PolarArea options={optionsPolar} data={
                                    {
                                        labels: recruiterPolar?.map(({ active_searchs }) => active_searchs),
                                        datasets: [
                                            {
                                                label: '# of Votes',
