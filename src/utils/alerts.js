...
export const alertEditSearch = ({
  ...
  return Swal.fire({
    ...
    title: "Para habilitar la edición del país o el area, se desvinculará al reclutador asignado de esta busqueda.",
    text: "Esta acción es irreversible!",
    iconColor: "#fff",
    showCancelButton: true,
    buttonsStyling: false,
    ...
    if (result.isConfirmed) {
      dispatch(deleteRecruiterSearch(searchId))
...
export const alertExistRecruiter = () => {
  return Swal.fire({
    ...
    title: "El reclutador ya fué ingresado!",
    iconColor: "#fff",
    buttonsStyling: false,
    confirmButtonText: "OK",
    customClass: {
